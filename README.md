...
**私のように､文面でのやり取りを通じてディスカッションをしたいと思っているが､既存のQ＆Aサイトや掲示板はその場として不適当だと考えている人**   
の   
**文面のやり取りを通じてディスカッションを行うこと自体を諦めてしまう｡もしくは､既存のQ＆Aサイトや掲示板でディスカッションをしようとしても､議論の発展に寄与する意見が投稿されず､ただの雑談になってしまう｡結果､自身の知見が発展せず､欲求不満になってしまう問題**
