...
## アプリの概要
**ディスカッション情報を視覚化することに特化したコミュニュケーションアプリ**です｡

## 誰の､どうゆう問題を解決するためのアプリなのか
**文面でのやり取りを通じてディスカッションをしたいと思っているが､既存のQ＆Aサイトや掲示板はその場として不適当だと考えている人**   
の   
**文面のやり取りを通じてディスカッションを行うこと自体を諦めてしまう｡もしくは､既存のQ＆Aサイトや掲示板でディスカッションをしようとしても､議論の発展に寄与する意見が投稿されず､ただの雑談になってしまう｡結果､知見が発展せず､｢疑問に対する答え｣や｢課題に対する解決策｣の質を向上させることができないという問題**
...
2. 文章を読まずとも｢意見の種類｣､｢どの反論が､どの意見の､どの部分に対して批判を提示しているのか｣､｢意見の構成｣の3点を把握できること
3. 1つの意見に複数の反論が作成されても､意見ー反論間の関係が分かりやすいこと

### 背景
&nbsp;&nbsp;日常生活を送る中でふと疑問に思った｡｢早起きは本当に健康によいのか?｣
...
&nbsp;&nbsp;しかし､ディスカッションはそんなものを得るために行うものではない｡ディスカッションの目的は､｢より正しい結論｣や｢よりよい解決策｣を導き出すことである｡そのような実りある建設的なディスカッションを行うためには､「主張→反論→再反論」という流れを作る必要がある｡そのためには､反論のとっかかりが多い意見､つまり､結論､理由､証拠の3要素を備えた意見を増やすことが重要になってくるのだが､その3要素を満たすことを､フォーマット無しの自由記述方式で実現することは難しい｡

&nbsp;&nbsp;第二に､文章を読まないと｢意見の種類｣､｢どの反論が､どの意見の､どの部分に対して批判を提示しているのか｣､｢意見の構成｣の3点を､把握できないという点が挙げられる｡  
...
→
* ｢意見の種類｣に関しては､意見を｢主張｣と｢反論｣の2種類に大別し､両者を色で判別できるよう｢主張｣を｢ピンク｣､｢反論｣を｢青｣で色分けすることで対応
  
<br/>

* ｢どの反論が､どの意見の､どの部分に対して批判を提示しているのか｣については､反論左上の｢黒色の丸｣から､意見中の｢結論｣｢理由｣｢証拠｣要素の左右の｢ピンク色の丸 or 空色の丸｣や各要素間の｢ピンク色の丸 or 空色の丸｣に赤い接続線を引けるようにすることで対応
...
## 既存のQ&Aサイト(イメージ)と本アプリで同様の議論展開がされたときの比較

<img width="1487" alt="比較画像 完成版" src="https://github.com/tikuwabux/VisualDiscussion/assets/111355072/490f2ad2-4b17-42f2-9828-de34dc386aef">


## 対面でのディスカッションと比較して､本アプリを使用した文面でのディスカッションを行うメリットとデメリット
### メリット
1. **気軽にディスカッションの場を設けることができる**
 >理由: メンバーを集める手間を省けるから｡
<br/>

2. **気軽にディスカッションの場に参加することができる**
>理由: いつでも好きな時間に参加することができる｡ + 事前準備(配布資料の読み込みなど)が不要｡ などの理由から｡
<br/>

3. **ディスカッション全体の正確性や一貫性を底上げすることができる**
>理由: インプットやアウトプットのスピードが遅い人でも､時間をかけることで､他人の意見の理解度を上げたり､自分の意見の正確性や一貫性を高めることが可能だから｡



### デメリット
1.**意見を集めるのに時間がかかる**
>理由: 複数人によるリアルタイムでのディスカッションには向かない｡ + 書くよりも話す方が早い｡ + 時間制限がない｡ などの理由から｡
<br/>

2.**意見を理解するのに時間がかかる**
>理由: 非言語コミュニティケーションやリアルタイムな補助説明が介在しないから｡


## おすすめの使い方
**1人で､時間があるときに､興味がある議題を探索/作成し､他人の意見をゆっくり精査したり､自分の意見をゆっくり作成する**
>理由: メリット1,2,3が余すことなく活かされていることに加え､デメリット1,2が解消されているから｡

## おすすめできない使い方
**複数人によるリアルタイムでの使用**
>理由: メリット1,2が消滅してしまうことに加え､ メリット3に｢意見の作成や理解を丁寧に行うほど､待機しているメンバーの待ち時間が増える｣という強力なデメリットが付加されてしまうから｡
