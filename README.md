...
の   
**文面のやり取りを通じてディスカッションを行うこと自体を諦めてしまう｡もしくは､既存のQ＆Aサイトや掲示板でディスカッションをしようとしても､議論の発展に寄与する意見が投稿されず､ただの雑談になってしまう｡結果､知見が発展せず､｢疑問に対する答え｣や｢課題に対する解決策｣の質を向上させることができない問題**
